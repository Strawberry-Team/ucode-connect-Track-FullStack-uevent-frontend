    ...
    <div className="min-h-screen flex bg-white dark:bg-black">
      ...
      <div className="w-64 bg-emerald-600 dark:bg-emerald-700 flex-shrink-0 fixed h-full">
        <div className="p-6 flex items-center space-x-2">
          ...
          <div className="h-6 bg-emerald-500 rounded w-20 animate-pulse"></div>
        </div>
        ...
        <div className="p-8">
          ...
          <div className="mb-8 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-800">
            <div className="flex justify-between items-center px-6 py-4 border-b border-gray-100 dark:border-gray-700">
              ...
              <div className="h-8 w-16 bg-emerald-200 dark:bg-emerald-800 rounded-md animate-pulse"></div>
            </div>
            ...
            <div className="p-6">
              <div className="grid grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="h-10 bg-gray-100 dark:bg-gray-700 rounded-lg w-full animate-pulse"></div>
                </div>
          ...
          <div className="mb-8 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-800">
            <div className="flex justify-between items-center px-6 py-4 border-b border-gray-100 dark:border-gray-700">
              <div className="h-6 bg-gray-200 dark:bg-gray-700 rounded w-48 animate-pulse"></div>
              <div className="h-8 w-36 bg-emerald-200 dark:bg-emerald-800 rounded-md animate-pulse"></div>
            </div>
            ...
            <div className="p-6">
              ...
              <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg mb-6 flex">
                ...
                <div className="flex-1">
                  <div className="h-5 bg-green-100 dark:bg-green-800 rounded w-40 mb-2 animate-pulse"></div>
                  <div className="h-4 bg-green-100 dark:bg-green-800 rounded w-full animate-pulse"></div>
                </div>
              </div>
              ...
              <div className="flex justify-between items-center py-4">
                <div className="flex items-start">
                  <div className="w-8 h-8 bg-gray-200 dark:bg-gray-700 rounded-lg mr-3 animate-pulse"></div>
                  <div>
                    <div className="h-5 bg-gray-200 dark:bg-gray-700 rounded w-48 mb-1 animate-pulse"></div>
